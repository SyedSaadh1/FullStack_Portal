		...
		<div className="bg-slate-50">
				...
				<Container className="rounded-lg py-16">
					...
					<div className="flex justify-between items-center">
						<div className="flex-1">
							...
							<Lead className="mt-4">
                A Fusion of Interactive Learning, Hands-On Practice, and
                Personalized Mentoring. Experience the Fun and Efficacy of
			...
			<section className="bg-muted py-8">
				<Container className="flex">
					<div>
						<TextSmall>
              © Copyright {new Date().getFullYear()} Fullstack.Institute - All
              Rights Reserved.
						</TextSmall>
					</div>
              ...
              navLinks.map(({ title, links }) => (
              	<div key={title} className="bg-neutral text-neutral-content">
              		<h6 className="scroll-m-20 text-xl font-semibold tracking-tight pb-3">
              			{title}
              		</h6>
