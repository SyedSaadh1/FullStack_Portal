...
import {
	CAMERA_AUDIO_TYPE,
	CAMERA_VIDEO_EXTENSION,
	CAMERA_VIDEO_TYPE
} from './camera.constants';

export const convertBlobIntoFile = (
	recordedChunks: BlobPart[],
	type = CAMERA_VIDEO_TYPE
) => {
...
export const generatePreviewAudioUrl = (recordedChunks: BlobPart[]) => {
	const blob = convertBlobIntoFile(recordedChunks, CAMERA_AUDIO_TYPE);
	return URL.createObjectURL(blob);
};

export const downloadRecordVideo = (
	recordedChunks: BlobPart[],
